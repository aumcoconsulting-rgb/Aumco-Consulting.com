...
const Process = () => (
  <section id="process" className="py-20 px-[5%] bg-primary">
    <div className="max-w-[1100px] mx-auto">
      ...
      <p className="text-base text-primary-foreground/55 max-w-[520px] leading-[1.7] mb-12">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-0 relative mt-2.5">
        ...
        {steps.map((step) => (
          <div key={step.num} className="text-center px-6 relative z-10">
            <div className="w-[72px] h-[72px] rounded-full bg-gold text-primary font-heading text-2xl font-black flex items-center justify-center mx-auto mb-5 shadow-[0_0_0_6px_rgba(201,152,58,0.15)]">
              {step.num}
            </div>
      ...
      <div className="text-center mt-12">
        <a
          href="#contact"
          className="inline-block no-underline font-body font-semibold text-sm px-7 py-3.5 rounded-lg bg-gold text-primary hover:bg-gold-light hover:-translate-y-0.5 transition-all"
        >
