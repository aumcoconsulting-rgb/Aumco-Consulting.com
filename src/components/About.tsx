...
const About = () => (
  <section id="about" className="py-20 px-[5%] bg-card">
    <div className="max-w-[1100px] mx-auto grid grid-cols-1 md:grid-cols-2 gap-[60px] items-start">
      <div>
      ...
      <div className="pt-2">
        {aboutCards.map((card) => (
          <div
            key={card.title}
            className="bg-background rounded-lg p-7 mb-4 border-l-[3px] border-gold"
          >
