...
const Pricing = () => (
  <section id="offers" className="py-16 md:py-20 px-[5%] bg-background">
        ...
        <div className="flex items-center justify-center flex-wrap bg-primary rounded-[14px] p-5 md:p-6 mb-10 gap-0">
          {guarantees.map((g, i) => (
            <div key={g.title} className="contents">
              <div className="flex items-center gap-3 px-4 md:px-7 py-2 flex-1 min-w-[200px] justify-center">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-[18px] items-start">
        {packages.map((pkg, i) => (
          <ScrollReveal key={pkg.name} delay={i * 120}>
            <div
              className={`rounded-2xl p-6 md:p-7 relative border-[1.5px] hover:shadow-[0_8px_40px_rgba(13,27,46,0.10)] hover:-translate-y-[3px] transition-all ${
                pkg.featured
            ...
            >
              ...
              <a
                href="#contact"
                className={`block w-full text-center no-underline font-body font-semibold text-sm px-5 py-3 rounded-lg transition-all min-h-[44px] leading-[44px] ${
                  pkg.featured
        ...
        <ScrollReveal delay={360}>
          <div className="rounded-2xl p-6 md:p-7 border-2 border-dashed border-muted-foreground/30 bg-background text-center flex flex-col justify-center items-center min-h-[420px] lg:min-h-0">
            ...
            <a
              href="#contact"
              className="block w-full text-center no-underline font-body font-semibold text-sm px-5 py-3 rounded-lg bg-primary text-primary-foreground hover:bg-navy-mid transition-all min-h-[44px] leading-[44px]"
            >
              Let's Talk →
            </a>
