...
const Portfolio = () => (
  <section id="portfolio" className="py-20 px-[5%] bg-card">
    <div className="max-w-[1100px] mx-auto">
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 mb-14">
        {stats.map((s) => (
          <div key={s.label} className="bg-primary rounded-lg p-7 text-center">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        {cases.map((c) => (
          <div
            key={c.client}
            className="bg-background rounded-2xl overflow-hidden border border-input hover:shadow-[0_8px_40px_rgba(13,27,46,0.10)] hover:-translate-y-1 transition-all"
          >
