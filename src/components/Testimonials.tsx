...
const Testimonials = () => (
  <section id="testimonials" className="py-20 px-[5%] bg-primary">
    <div className="max-w-[1100px] mx-auto">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
        {testimonials.map((t) => (
          <div
            key={t.name}
            className="bg-primary-foreground/5 border border-primary-foreground/10 rounded-lg p-7 hover:bg-primary-foreground/[0.08] transition-colors"
          >
