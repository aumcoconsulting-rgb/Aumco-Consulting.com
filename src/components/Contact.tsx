...
const Contact = () => {
  ...
  return (
    <section id="contact" className="py-16 md:py-20 px-[5%] bg-card">
      <div className="max-w-[1100px] mx-auto grid grid-cols-1 md:grid-cols-[1fr_1.3fr] gap-10 md:gap-[60px] items-start">
        <ScrollReveal direction="left">
          <div>
            ...
            <div className="mt-7 flex flex-col gap-4">
              <a href="tel:+919003748116" className="flex items-center gap-4 bg-background rounded-[10px] p-4 no-underline hover:shadow-md transition-shadow">
                ...
                <div>
                  ...
                  <span className="text-[0.95rem] font-semibold text-primary">+91 90037 48116</span>
                </div>
              </a>
              <a href="mailto:consult@aumcoconsulting.com" className="flex items-center gap-4 bg-background rounded-[10px] p-4 no-underline hover:shadow-md transition-shadow">
                ...
                <div>
                  ...
                  <span className="text-[0.95rem] font-semibold text-primary">consult@aumcoconsulting.com</span>
                </div>
              </a>
            </div>
            ...
            <div className="flex gap-2.5 mt-6 flex-wrap">
              {[
                ...
                <a
                  ...
                  className="inline-flex items-center gap-1.5 bg-primary text-primary-foreground no-underline text-[0.82rem] font-semibold px-4 py-2.5 rounded-lg hover:bg-gold hover:text-primary transition-colors min-h-[44px]"
                >
                  {s.label}
                </a>
              ))}
            ...
            <form onSubmit={handleSubmit}>
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3.5">
                <div className="flex flex-col gap-1.5 mb-3.5">
                  ...
                  <input
                    ...
                    className="font-body text-sm p-3 border-[1.5px] border-input rounded-lg bg-card text-foreground outline-none focus:border-primary focus:ring-2 focus:ring-primary/20 transition-all min-h-[44px]"
                  />
                </div>
                <div className="flex flex-col gap-1.5 mb-3.5">
              ...
              <div className="flex flex-col gap-1.5 mb-3.5">
                ...
                <textarea
                  ...
                  className="font-body text-sm p-3 border-[1.5px] border-input rounded-lg bg-card text-foreground outline-none focus:border-primary focus:ring-2 focus:ring-primary/20 transition-all resize-y"
                />
              </div>
              <button
                type="submit"
                className="w-full bg-[#25D366] text-primary-foreground font-body font-bold text-base py-3.5 rounded-lg border-none cursor-pointer hover:opacity-90 hover:shadow-lg transition-all min-h-[48px]"
              >
                💬 Send via WhatsApp
              </button>
